...
namespace MatFlatTest
{
    public class BlasTests_MulMatMat
    {
        ...
        public unsafe void MulMatMatDouble_NT(int m, int n, int k, int lda, int ldb, int ldc)
        {
            var a = Matrix.RandomDouble(42, m, k, lda);
        ...
        public unsafe void MulMatMatDouble_TT(int m, int n, int k, int lda, int ldb, int ldc)
        {
            var a = Matrix.RandomDouble(42, k, m, lda);
            var b = Matrix.RandomDouble(57, n, k, ldb);
            var c = Matrix.RandomDouble(0, m, n, ldc);
