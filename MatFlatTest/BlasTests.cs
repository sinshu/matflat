...
namespace MatFlatTest
{
    public class BlasTests
    {
        ...
        [TestCase(10, 10, 1)]
        [TestCase(10, 17, 5)]
        public unsafe void ForwardSubstitutionDouble_LowerNoTrans(int n, int lda, int incx)
        {
        ...
        [TestCase(10, 10, 1)]
        [TestCase(10, 17, 5)]
        public unsafe void ForwardSubstitutionDouble_UpperTrans(int n, int lda, int incx)
        {
            var a = Matrix.RandomDouble(42, n, n, lda);
            for (var row = 0; row < n; row++)
            {
